...
|---|---|
| Region | Singapore |
| Third-party domain | `app-edpjehy9dc75-api-GaDwzVOqmRNY.gateway.appmedo.com` |
| Method | `GET` |
| Upstream path | `/tasks` |
| API Plugin ID | `73eecc62-33b0-48d6-aa34-7d309680476b` |
| API Plugin API ID | `api-GaDwzVOqmRNY` |
| API Plugin endpoint | `GET https://app-edpjehy9dc75-api-GaDwzVOqmRNY.gateway.appmedo.com/tasks` |
