...
**Endpoint:** `GET https://app-edpjehy9dc75-api-Xa6JZq205MNa.gateway.appmedo.com/v1/entity/search`
...
async function searchEntities(params: EntitySearchParams = {}): Promise<EntitySearchResponse> {
  ...
  const response = await fetch(
    `https://app-edpjehy9dc75-api-Xa6JZq205MNa.gateway.appmedo.com/v1/entity/search?${query.toString()}`,
