...
| Purpose | Endpoint |
|---|---|
| Create motion-control task | `POST https://app-edpjehy9dc75-api-m9xKdopkqvMa.gateway.appmedo.com/motion-control/kling-3.0` |
| Query exact task IDs | `GET https://app-edpjehy9dc75-api-qYGWzQv1x4GY.gateway.appmedo.com/tasks` |
