...
| Item | Details |
|------|---------|
| Endpoint | `POST https://app-edpjehy9dc75-api-GaDwZ8DX7jPY.gateway.appmedo.com/language/translate/v2` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    "https://app-edpjehy9dc75-api-GaDwZ8DX7jPY.gateway.appmedo.com/language/translate/v2",
    {
      method: "POST",
      headers: {
