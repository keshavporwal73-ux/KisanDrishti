...
**Endpoint:** `GET https://app-edpjehy9dc75-api-AalZze1qEWML.gateway.appmedo.com/v1/news/all`
...
async function getFinanceNews(params: NewsParams = {}): Promise<NewsResponse> {
  ...
  const response = await fetch(
    `https://app-edpjehy9dc75-api-AalZze1qEWML.gateway.appmedo.com/v1/news/all?${query.toString()}`,
