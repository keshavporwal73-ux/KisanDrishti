...
| Item | Details |
|------|---------|
| Create Task Endpoint | `POST https://app-edpjehy9dc75-api-DY8MnRlwkXKa.gateway.appmedo.com/v1/images/generations` |
| Query Task Endpoint | `GET https://app-edpjehy9dc75-api-M9v0wzOkZXGY.gateway.appmedo.com/v1/images/generations/{task_id}` |
