...
| Item | Details |
|------|---------|
| Create Task Endpoint | `POST https://app-edpjehy9dc75-api-GYX1bbkRQj4a.gateway.appmedo.com/v1/images/editing/expand` |
| Query Task (Single) Endpoint | `GET https://app-edpjehy9dc75-api-AalZkkAG5w7L.gateway.appmedo.com/v1/images/editing/expand/{task_id}` |
| Query Task (List) Endpoint | `GET https://app-edpjehy9dc75-api-pLVzAAkGZwDL.gateway.appmedo.com/v1/images/editing/expand` |
