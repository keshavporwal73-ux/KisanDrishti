...
| Property | Value |
|----------|-------|
| Endpoint | `POST https://app-edpjehy9dc75-api-k93RvqRrRZba.gateway.appmedo.com/v1/videos/omni-video` |
| HTTP Method | `POST` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    "https://app-edpjehy9dc75-api-k93RvqRrRZba.gateway.appmedo.com/v1/videos/omni-video",
    {
      method: "POST",
      headers: {
