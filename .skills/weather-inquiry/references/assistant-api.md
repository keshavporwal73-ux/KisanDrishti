...
**Endpoint**: `POST https://app-edpjehy9dc75-api-79jKPlpvAJ0L.gateway.appmedo.com/assistant/session`
...
**Endpoint**: `POST https://app-edpjehy9dc75-api-oYA6ZxVqyK8a.gateway.appmedo.com/assistant/session/{session_id}`
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    "https://app-edpjehy9dc75-api-79jKPlpvAJ0L.gateway.appmedo.com/assistant/session",
    {
      method: "POST",
      headers: {
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    `https://app-edpjehy9dc75-api-oYA6ZxVqyK8a.gateway.appmedo.com/assistant/session/${sessionId}`,
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
