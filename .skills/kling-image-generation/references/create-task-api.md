...
| Item | Details |
|------|---------|
| Endpoint | `POST https://app-edpjehy9dc75-api-DY8MnRlwkXKa.gateway.appmedo.com/v1/images/generations` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    "https://app-edpjehy9dc75-api-DY8MnRlwkXKa.gateway.appmedo.com/v1/images/generations",
    {
      method: "POST",
      headers: {
